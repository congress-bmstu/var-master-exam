...
#theorem(title: "Метод Ритца")[
  ...
  #proof[
    Предположим, что в $H_A$ к базису $phi_1, phi_2, ...$ применимы процессы ортогонализации и нормирования и получен базис $tilde(phi)_1, tilde(phi)_2, ...$ --- ортонормированный.
    $
